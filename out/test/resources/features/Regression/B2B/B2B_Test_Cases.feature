...
#        |B2B Automated Test - Sweden Eltel    |B2B Automation, Sweden, Eltel     |SE_LTECell_103392011   |Eltel - FS - SE - B2B    |Nokia      |Team Sundsvall Serv                |NMC-MESSAGES@eltelnetworks.se   |118 Hour 5 days Cleanup correction time workdays          |   2     |     3      |
 #       |B2B Automated Test - Finland Eltel   |B2B Automation, Finland, Eltel    |FI_LTECell_Valpe4H     |Eltel - FS - FIN - B2B   |Nokia      |ELTEL ContactCenter                |nmc-messages@eltelnetworks.se    |#118 Hour 5 days Cleanup correction time workdays (FI=A3) |   1     |     1     |
