@Bulk_Loading_Format_change_XLSX_50CIs @SAO-427
Feature: checking of bulk loading format
  Scenario: user checks the format of bulk loading format
      ...
      #50CI's XLSX with no duplicate
      And user searches for "C:\Users\mahesh vaddegani\Downloads\Test Case Attachments 2\TemplatesForBulkCITests\50 CI's\50CIsXLSX.xlsx" attachment and adds it
