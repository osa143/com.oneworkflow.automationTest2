@BDL_AT3 @PLAZA
  Feature: Plaza BDL form test
    Scenario: user validates information sent to OW from Plaza
      ...
      And user selects BCPP environment as "AT3"
      And user selects BDL AT3 CI as "API"
      And user selects BDL AT3 CI as "AT3"
      And user selects BDL AT3 CI as "AT DB"
      And user selects BDL AT3 CI as "AT3_Store"
      And user selects BDL AT3 CI as "Databases"
      And user selects BDL AT3 CI as "E2V"
      And user selects BDL AT3 CI as "eMessaging"
      And user selects BDL AT3 CI as "Proofing"
      And user selects BDL AT3 CI as "Netbill DB-loader"
