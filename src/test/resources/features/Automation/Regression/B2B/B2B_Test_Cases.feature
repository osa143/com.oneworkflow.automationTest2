...
#        |B2B Automated Test - Norway Oneco    |B2B Automation, Norway, Oneco     |NO_LTECell_TLM150_L18-1|Oneco2 - FS - NO - B2B    |Huawei     |OneCo SPOC (Single Point Of Contact)| telecom.spoc@oneco.no           |118 Hour 5 days Cleanup correction time workdays        |   1     |     2      |
