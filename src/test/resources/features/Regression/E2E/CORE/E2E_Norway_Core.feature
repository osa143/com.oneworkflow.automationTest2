...
Feature: E2E Scenarios
  Scenario: E2E Scenarios for norway trouble event
    ...
    Then user validates norway and finland checkboxes are selected
    ...
    And user highlights location "NO_Site_VSF087" and clicks ok and validates location details
    When user enters "Test case MT004 Norway E2E" in Title field in Trouble event
    And user selects request type as "Customer" on trouble event page
    And user enters description as "Test case MT004 Norway E2E"
    ...
    And  user enters "NO_EPG_OSL900EPG2" in location field
    Then user clicks on search button on CI search window
    And user selects CI "NO_EPG_OSL900EPG2"
    ...
    And user validates "Primary" CI is equal to "NO_EPG_OSL900EPG2"
    Then user clicks on save button
