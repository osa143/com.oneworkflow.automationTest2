@XLS_Bulk_Loading_Format_duplicateCIs_trouble @SAO-427
    #passed
Feature: checking of bulk loading format
    Scenario: user checks the format of bulk loading format
        ...
        And user searches for "C:\Temp\com.oneworkflow.automation\src\test\resources\Test_Attachments\TestCaseAttachments\5DuplicateCIs\5CIsXLS.xls" attachment and adds it
