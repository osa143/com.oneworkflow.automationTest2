@SAO-427-BR2864-Bulk_Loading_Format_Name_Change @427
Feature: checking of bulk loading format
  Scenario: user checks the format of bulk loading format
      ...
      #10CI's with incorrect column name
      Then user selects file with incorrect column name
      And user clicks on attachment ok button
      Then user should see 10 CI's with incorrect column name attachment within bulk loading window
