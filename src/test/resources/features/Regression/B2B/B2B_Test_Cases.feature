...
#      And user switches to window 0
      ...
      Examples:
         ...
         |B2B Automated Test - Sweden Transtema|B2B Automation, Sweden, Transtema |SE_LTECell_100895010   |Transtema - FS - SE - B2B|Ericsson    |Transtema SOC                       |support.tns@transtema.com         |118 Hour 5 days Cleanup correction time workdays        |   2     |     3      |
#         |B2B Automated Test - Sweden Eltel    |B2B Automation, Sweden, Eltel     |SE_LTECell_103392011   |Eltel - FS - SE - B2B    |Nokia       |Team Sundsvall Serv                 |NMC-MESSAGES@eltelnetworks.se     |118 Hour 5 days Cleanup correction time workdays        |   2     |     3      |
         ...
         |B2B Automated Test - Norway Oneco    |B2B Automation, Norway, Oneco     |NO_LTECell_TLM150_L18-1|Oneco - FS - NO - B2B    |Huawei      |OneCo SPOC (Single Point Of Contact)| telecom.spoc@oneco.no            |118 Hour 5 days Cleanup correction time workdays        |   1     |     2      |
#         |B2B Automated Test - Lithuania Eltel |B2B Automation, Lithuania, Eltel  |LT_LTECell_2C16B011    |Eltel - FS - LT - B2B    |Huawei      |B2B Mobile Litauen                  |lars.bergh@eltelnetworks.se       |118 Hour 5 days Cleanup correction time workdays        |   2     |     3      |
