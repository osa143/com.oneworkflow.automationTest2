@Database_Configure_Database_Parameters @PLAZA @Database
  Feature: Database Configure Database Parameters plaza form test
    Scenario: user validates information sent to OW from Plaza
      ...
      And user selects service request name as "Configure Database Parameters"
      And user enters Database Configure request as "Test4 Database Configure/Request"
      And user selects Database Configure Database Type as "MSSQL"
      And user selects Database Configure server CI as "cc100cgas001"
      And user selects Database Configure add Database CI as "TEST"
      And user enters Database Configure Database Name as "Test name"
      And user enters Database Configure Parameters as "Test parameters"
      Then user enters Database Configure description as "Test4 Database/Description"
      And user enters additional comments as "Database - Test4/AC"
