...
Feature: checking of bulk loading format
  Scenario: user checks the format of bulk loading format
      ...
      #Need to change the file to correspond with correct file (Incorrect Column Location) XLSX
      And user searches for "C:\Users\mahesh vaddegani\Downloads\Test Case Attachments 2\TemplatesForBulkCITests\IncorrectFormatColumnName\BIR+Load+Template.xlsx" attachment and adds it
