@SAO-427-BR2864-Bulk_Loading_Format_Trouble_XLS_50CIs @427
Feature: checking of bulk loading format
  Scenario: user checks the format of bulk loading format
      ...
      #50 CI's with no duplicates XLS file
      Then user selects file with duplicates in it
      And user clicks on attachment ok button
      Then user should see 50 CI XLS attachment within bulk loading window
