...
Feature: Work Order Archive Form
  Scenario: User validates archive UI
    ...
    And user clicks on the search button
    Then user validates archived Work Orders are shown
    When user clicks on the new search button
    ...
    And user enters "%" in the "Completion Code" field
    And user clicks on the search button
    Then user validates closed archived Work Orders are shown
    When user clicks on the new search button
    And user clicks on closure under sections
    And user enters "%" in the "Withdrawn Reason" field
