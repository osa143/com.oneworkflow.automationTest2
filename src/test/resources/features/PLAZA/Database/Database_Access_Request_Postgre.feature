@Database_Access_Request_Postgre @PLAZA
  Feature: Database Access Request Postgre plaza form test
    Scenario: user validates information sent to OW from Plaza
      ...
      Then user selects Account Type as "Local"
      And user enters Account Name as "Test account name"
      Then user enters Permissions as "Test permissions"
      Then user enters Database Access Request Postgre description as "Test3 Database Access Postgre/Description"
