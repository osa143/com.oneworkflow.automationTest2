...
Feature: TroubleArchive Form
  Scenario: User validates archive UI
    ...
    Then user validates "Trouble" archive search form is opened
    ...
    And user clicks on the search button
    Then user validates archived trouble tickets are shown
    When user clicks on the new search button
    ...
    And user enters "%" in the "Fault Position" field
    And user clicks on the search button
    Then user validates closed archived trouble tickets are shown
    When user clicks on the new search button
    And user clicks on closure under sections
    And user enters "%" in the "Info" field
    And user clicks on the search button
    Then user validates closed archived trouble tickets are shown
    When user clicks on the new search button
    And user clicks on closure under sections
    And user enters "%" in the "Event End Time" field
    And user clicks on the search button
    Then user validates closed archived trouble tickets are shown
    When user clicks on the new search button
