@Bulk_Loading_Ignore_Duplicate_CI's_Trouble_CSV @SAO-427
  Feature: Bulk Loading ignore duplicate CI's
    Scenario: Bulk Loading ignore duplicate CI's
      ...
      And user searches for "C:\Users\mahesh vaddegani\Downloads\Test Case Attachments 2\TemplatesForBulkCITests\50 CI's (WithDuplicates)\50CIsCSV" attachment and adds it
