@Drop_Down
  Feature: user validates drop-downs for problem record
    Scenario: user verifies available information
      ...
      And user selects request type as "Core Switching:IMS Fixed" in problem form
      ...
      Then multiple statuses "Extensive/Widespread:Significant/Large:Moderate Limited" should be available in "Impact Level" dropdown
      And user selects impact level as "Extensive/Widespread"
      ...
      Then multiple statuses "Assigned:Pending:Under Investigation:Withdrawn" should be available in "Title" dropdown
      ...
      Then multiple statuses "Change:Known Error:Operations:Problem:Work Order" should be available in "Target Application first" dropdown
      When user selects target application first dropdown as "Change"
      #Second dropdown should include: Caused by, is related to, is workaround for, solution for
      Then multiple statuses "Caused by:Is related to:Is workaround for:Solution for" should be available in "Target Application second" dropdown
      When user selects target application first dropdown as "Known Error"
      #Second dropdown should include: Caused by, is related to, is workaround for, solution for
      Then multiple statuses "Caused by:Is related to:Is workaround for:Solution for" should be available in "Target Application second" dropdown
      When user selects target application first dropdown as "Operations"
      #Second dropdown should include: Caused by, is related to, is workaround for, solution for
      Then multiple statuses "Caused by:Is related to:Is workaround for:Solution for" should be available in "Target Application second" dropdown
      When user selects target application first dropdown as "Problem"
      #Second dropdown should include: Caused by, is related to, is workaround for, solution for
      Then multiple statuses "Caused by:Is related to:Is workaround for:Solution for" should be available in "Target Application second" dropdown
      When user selects target application first dropdown as "Work Order"
      #Second dropdown should include: Caused by, is related to, is workaround for, solution for
      Then multiple statuses "Caused by:Is related to:Is workaround for:Solution for" should be available in "Target Application second" dropdown
