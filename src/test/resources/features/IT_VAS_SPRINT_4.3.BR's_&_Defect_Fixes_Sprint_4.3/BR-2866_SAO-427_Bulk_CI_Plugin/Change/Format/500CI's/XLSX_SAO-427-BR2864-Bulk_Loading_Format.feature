@Bulk_Loading_Format_Trouble_XLSX_500CIs @427
Feature: checking of bulk loading format
  Scenario: user checks the format of bulk loading format
      ...
      #Need to change the file to correspond with correct file (Duplicate CI Names) xlsx
      And user searches for "C:\Users\mahesh vaddegani\Downloads\Test Case Attachments 2\TemplatesForBulkCITests\500 CI's - Correct Names\BIR+Load+Template.xlsx" attachment and adds it
