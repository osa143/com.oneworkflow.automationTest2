@Profile_Permissions_Part_2 @problem @Reg_Problem
  #Passed
  ...
  Feature: profile permissions part 2
    Scenario:  profile permissions part 2
      ...
      When user creates problem ticket with following details
        ...
        |Proactive investigation of frvi96_auto|CPS:IT:Other|UAT Profile Permissions test2|Moderate/Limited|Low    |CA_Infra      |CA_IT      |
