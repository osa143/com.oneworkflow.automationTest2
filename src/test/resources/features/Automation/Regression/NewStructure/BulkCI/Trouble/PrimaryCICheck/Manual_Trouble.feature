@Manual_Bulk_Loading_Primary_CI_Default_Settings2 @SAO-427
  #passed
...
#    When user clicks on sweden checkbox under affected BU's
    ...
    Then user enters "SE_AP_tylosand-first-camp-ap10b2;SE_AP_tylosand-first-camp-ap11;SE_AP_tylosand-first-camp-ap12b2;SE_AP_tylosand-first-camp-ap13;" in manual CI search box
    ...
    Then user validates primary ci as "SE_AP_tylosand-first-camp-ap10b2"
