@Storage_Configure_VLAN @PLAZA
  Feature: Storage Configure VLAN plaza form test
    Scenario: user validates information sent to OW from Plaza
      ...
      And user selects storage configure trunk CI as "cc100cgas001"
      Then user enters Storage description as "Test1 Storage Configure/Description"
      And user enters additional comments as "Test1 Storage Configure/AC"
      ...
      And user validates title field as "Service Request | Configure VLAN Storage Node/NAS"
