...
#    And user enters "Trouble Ticket Auto Assignment Automation Test" in Title field in Trouble event
...
#    And user should see assigned profile as "Incident Manager"
#    And user validates assignee is "ahu727"
...
#    When user clicks on sweden checkbox under affected BU's
#    And user enters "Work Order Auto Assignment Automation Test" in Title field
...
#    And user enters "Known Error Auto Assignment Automation Test" in Title field
...
#    And the Assignment Profile is set based on the assignment rule with the highest priority sort order value
#    And user clicks on assignment under sections
#    And user should see assigned profile as "IoT-operation"
#    And user validates assignee is "ayf010"
#    And user logsOut and closes the browser
#    And user switches to window 0
...
#    Then trouble record form should appear in new tab
#    When user clicks on sweden checkbox under affected BU's
#    When user enters "Problem Ticket Auto Assignment Automation Test" in Title field
...
#    And the Assignment Profile is set based on the assignment rule with the highest priority sort order value
#    And user clicks on assignment under sections
#    And user should see assigned profile as "OSS ADM CGI"
#    And user validates assignee is "azs681"
#    And user logsOut and closes the browser
#    And user switches to window 0
...
#    Then trouble record form should appear in new tab
#    When user clicks on sweden checkbox under affected BU's
#    And user enters "This ticket should be auto assigned to OP Auto Assignment LIKE Condition Automation Test Rule" in Title field in Trouble event
#    And user selects request type as "Customer" on trouble event page
#    And user enters description as "Trouble event Auto Assignment to Appropriate Group"
#    And user clicks on save button
#    Then ticket should be created and status should be assigned
...
#    And the Assignment Profile is set based on the assignment rule with the highest priority sort order value
#    And user clicks on assignment under sections
#    And user should see assigned profile as "L2 Fixed Voice-SE"
#    And user validates assignee is "robcar"
#    And user logsOut and closes the browser
#    And user switches to window 0
#
#  Scenario: Work order
...
#    Then work order form should appear in new tab
#    When user clicks on sweden checkbox under affected BU's
#    And user enters "This ticket should be auto assigned to WO Auto Assignment LIKE Condition Automation Test Rule" in Title field
#    And user selects request type as "Analysis" in work order page
#    And user enters description as " Work order Auto Assignment Test"
#    And user selects priority as "Info"
#    Then user clicks on save button
...
#    And user clicks on assignment under sections
#    And user should see assigned profile as "OSS ADM CGI"
#    And user validates assignee is "mano21"
#    And user logsOut and closes the browser
#    And user switches to window 0
#
#
...
#    And user switches to window 1
#    Then known error form should appear in new tab
#    And user enters "This ticket should be auto assigned to KE Auto Assignment LIKE Condition Automation Test Rule" in Title field
#    And user selects request type as "Rejected:Ticket Rejected" on known error page
#    And user enters description as "A known error Auto Assignment Test"
#    And user selects priority as "Minor"
#    And user clicks on save button
...
#    And the Assignment Profile is set based on the assignment rule with the highest priority sort order value
#    And user clicks on assignment under sections
#    And user should see assigned profile as "TV Backend"
#    And user validates assignee is "thar02"
#    And user logsOut and closes the browser
#    And user switches to window 0
#
#  Scenario: Problem Ticket
...
#    And user switches to window 0
  ...
  Scenario: Change Ticket
    ...
    And user validates assignee is "zae878"
