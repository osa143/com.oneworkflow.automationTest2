@Bulk_Loading_Format_Trouble_TXT_500CIs @427
Feature: checking of bulk loading format
  Scenario: user checks the format of bulk loading format
      ...
      And user searches for "C:\Users\mahesh vaddegani\Downloads\Test Case Attachments 2\TemplatesForBulkCITests\500 CI's - Correct Names\BIR+Load+Template.txt" attachment and adds it
