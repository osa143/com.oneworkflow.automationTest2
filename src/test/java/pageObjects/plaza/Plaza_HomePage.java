...
public class Plaza_HomePage extends BaseRecordPage {
    ...
    public static final String dd_ROLE_ID= "select2-chosen-7";
    ...
    public static final String dd_SERVICE_REQUEST_NAME_ID= "select2-chosen-9";
    ...
    public static final String dd_C2B_SERVICE_ENVIRONMENT="s2id_autogen11";
    ...
    public static final String dd_BACK_UP_ADD_CI= "s2id_autogen12";
    ...
    public static final String dd_ADD_CI = "s2id_autogen11";
    public static final String dd_NETWORK_ADD_CI = "s2id_autogen12";
    ...
    public static final String dd_DATABASE_ACCOUNT_TYPE= "select2-chosen-12";
    ...
    public static final String dd_DATABASE_REQUEST_CHOOSE_ACTION= "select2-chosen-16";
    public static final String dd_DATABASE_REQUEST_LOCATION= "select2-chosen-18";
    public static final String txt_DATABASE_REQUEST_PLANNED_START_DATE_TIME= "sp_formfield_sr115_v_start_date";
    public static final String dd_DATABASE_REQUEST_DATABASE_TYPE= "select2-chosen-10";
    ...
    public static final String dd_DATABASE_CONFIGURE_PARAMETER_DATABASE_TYPE= "select2-chosen-10";
    ...
    public static final String dd_DATABASE_PERFORMANCE_TROUBLESHOOTING_DB_TYPE="select2-chosen-10";
    ...
    private static final String dd_NIMBUS_ADD_CI= "s2id_autogen16";
    private static final String dd_NIMBUS_TYPE= "select2-chosen-11";
    ...
    private static final String dd_NIMBUS_EXTEND_DISK_ADD_CI= "s2id_autogen17";
    ...
    private static final String dd_NIMBUS_CLOUD_SERVICES= "s2id_autogen18";
    private static final String dd_NIMBUS_TARGET_COUNTRIES= "s2id_autogen20";
    ...
    private static final String dd_NIMBUS_RESTORE_VM= "s2id_autogen19";
    ...
    public static final String dd_NETWORK_SECURITY_FIREWALL_NEW_CHANGE_ADD_CI= "s2id_autogen13";
    public static final String dd_NETWORK_SECURITY_SWITCH_PORT_CONFIG_ADD_CI= "s2id_autogen15";
    ...
    private static final String dd_NETWORK_SECURITY_NEW_SWITCH_NETWORK_CI= "s2id_autogen16";
    ...
    private static final String dd_STORAGE_EXPORT_SOURCE_CI= "s2id_autogen12";
    ...
    private static final String dd_STORAGE_EXPORT_TARGET_CI= "s2id_autogen13";
    ...
    private static final String dd_BCPP_ADD_CI = "s2id_sp_formfield_sr107_v_add_ci";
    ...
    private static final String dd_MEGADISC_ADD_USER_SELECT_GROUP= "s2id_sp_formfield_sr75_v_select_group";
    ...
    private static final String dd_STORAGE_VOLUME_CHOOSE_OPTION= "s2id_sp_formfield_sr62_v_choose_opt";
    ...
    private static final String dd_TCFP_ADD_USER_CHOOSE_OPTION= "select2-chosen-10";
    private static final String txt_TCFP_ADD_USER_ACCOUNT_NAME= "sp_formfield_sr68_v_account_name";
    private static final String dd_TCFP_ADD_USER_SELECT_GROUP= "s2id_autogen13";
    ...
    private static final String dd_SPAN_CI= "s2id_sp_formfield_sr107_v_add_ci";
    ...
    private static final String dd_TOPCAT_ADD_CI= "s2id_autogen12";
    ...
    private static final String dd_CI_WEBTAB = "//input[@aria-owns='s2id_autogen11_results']";
    ...
    private static final String txt_TOPCAT_ADD_CI = "s2id_autogen12_results";
    private static final String txt_SPAN_ADD_CI = "s2id_autogen13_results";
    ...
    private static final String txt_TCFP_ADD_USER_CHOOSE_OPTION = "select2-results-10";
    private static final String txt_TCFP_ADD_USER_SELECT_GROUP = "s2id_autogen13_results";
    private static final String txt_STORAGE_VOLUME_CHOOSE_OPTION = "select2-results-9";
    private static final String txt_MEGADISC_ADD_USER_REQUESTED_PERSON = "select2-results-13";
    private static final String txt_MEGADISC_ADD_USER_SELECT_GROUP = "s2id_autogen12_results";
    ...
    private static final String txt_BCPP_ADD_CI = "s2id_autogen15_results";
    private static final String txt_STORAGE_EXPORT_SOURCE_CI = "s2id_autogen12_results";
    private static final String txt_STORAGE_EXPORT_TARGET_CI = "s2id_autogen13_results";
    ...
    private static final String txt_NETWORK_SECURITY_PROXY_SURF_PROXY_SLOW_SURFING_SITES = "select2-results-11";
    ...
    private static final String txt_NETWORK_SECURITY_NEW_SWITCH_NETWORK_CI = "s2id_autogen16_results";
    private static final String txt_NETWORK_SECURITY_FIREWALL_NEW_CHANGE_ADD_CI = "s2id_autogen13_results";
    private static final String txt_NETWORK_SECURITY_SWITCH_PORT_CONFIG_ADD_CI = "s2id_autogen15_results";
    private static final String txt_NETWORK_SECURITY_FIREWALL_NEW_CHANGE_SERVICE_REQUEST = "select2-results-9";
    private static final String txt_NETWORK_SECURITY_ADD_MODIFY_REMOVE_SCHEDULED_CHANGE = "select2-results-10";
    private static final String txt_NETWORK_SECURITY_ADD_MODIFY_REMOVE_DNS_SERVICE_REQUEST_NAME = "select2-results-11";
    private static final String txt_NIMBUS_RESTORE_VM = "s2id_autogen19_results";
    private static final String txt_NIMBUS_TARGET_COUNTRIES = "s2id_autogen20_results";
    private static final String txt_NIMBUS_CLOUD_SERVICES = "s2id_autogen18_results";
    private static final String txt_NIMBUS_EXTEND_DISK_ADD_CI = "s2id_autogen17_results";
    private static final String txt_NIMBUS_ADD_CI = "s2id_autogen16_results";
    private static final String txt_NIMBUS_TYPE = "select2-results-11";
    private static final String txt_DATABASE_PERFORMANCE_TROUBLESHOOTING_SERVER_CI = "s2id_autogen32_results";
    private static final String txt_DATABASE_PERFORMANCE_TROUBLESHOOTING_DB_CI = "s2id_autogen33_results";
    private static final String txt_DATABASE_PERFORMANCE_TROUBLESHOOTING_DB_TYPE = "select2-results-10";
    private static final String txt_DATABASE_CONFIGURE_PARAMETER_ADD_CI = "s2id_autogen37_results";
    private static final String txt_DATABASE_CONFIGURE_PARAMETER_DATABASE_ADD_CI = "s2id_autogen38_results";
    private static final String txt_DATABASE_CONFIGURE_PARAMETER_DATABASE_TYPE = "select2-results-10";
    private static final String txt_DATABASE_REQUEST_ADD_CI = "s2id_autogen35_results";
    private static final String txt_DATABASE_REQUEST_ADD_SERVER_CI = "s2id_autogen34_results";
    private static final String txt_DATABASE_REQUEST_DATABASE_TYPE = "select2-results-10";
    private static final String txt_DATABASE_REQUEST_LOCATION = "select2-results-18";
    private static final String txt_DATABASE_REQUEST_CHOOSE_ACTION = "select2-results-16";
    private static final String txt_DATABASE_NEW_EXISTING_ACCOUNT = "select2-results-13";
    private static final String txt_NETWORK_SECURITY_NEW_EXISTING_ACCOUNT="select2-results-14";
    private static final String txt_ADD_DATABASE_CI = "s2id_autogen23_results";
    private static final String txt_ADD_SERVER_CI = "s2id_autogen24_results";
    private static final String txt_DATABASE_ACCOUNT_TYPE = "select2-results-12";
    private static final String txt_ADDCI = "s2id_autogen11_results";
    private static final String txt_NETWORK_ADD_CI = "s2id_autogen12_results";
    ...
    private static final String txt_BACK_UP_ADD_CI = "s2id_autogen12_results";
    ...
    private static final String txt_CRM_SYSTEM = "select2-results-12";
    private static final String txt_ROLE_ID = "select2-results-7";
    private static final String txt_SYSTEM_ID = "select2-results-13";
    private static final String txt_SERVICE_REQUEST_NAME_ID = "select2-results-9";
    private static final String txt_SELECT_REQUEST_ID = "select2-results-10";
    private static final String ddValue_REMOTE_ACCESS_SELECT_REQUEST_ID="select2-results-9";
    private static final String txt_SMTP_RELAY = "select2-results-10";
    private static final String txt_C2B_SERVICE_ENVIRONMENT = "s2id_autogen11_results";
    private static final String txt_C2B_GENERAL_ENVIRONMENT = "s2id_autogen14_results";
    private static final String txt_ENVIRONMENT = "s2id_autogen13_results";
...
//        return AttachmentMessage;
    ...
    public void select_add_ci(String dropdownName){
        PlazaValidation.System = dropdownName;
        PlazaValidation.CI = dropdownName;
        selectDropdownWithMultipleValues(By.id(dd_OCC_CI), By.id(txt_ADD_CI_TEXT_BOX),  dropdownName);
    ...
    public void selectBCPP_ADD_CI (String dropdownName){
//        PlazaValidation.CI = dropdownName;
//        clickElement(By.id(dd_BCPP_ADD_CI));
//        wait(1000);
//        driver.switchTo().activeElement().sendKeys(Keys.ENTER);
//        selectDropdownWithMultipleValues(By.id(dd_BCPP_ADD_CI), By.id(txt_BCPP_ADD_CI), dropdownName);
        PlazaValidation.CI = dropdownName;
        clickElement(By.id(dd_BCPP_ADD_CI));
        wait(1000);
    ...
    public void selectNetwork_EquipmentCI (String dropdownName){
        PlazaValidation.CI = dropdownName;
        selectDropdownWithMultipleValues(By.id(dd_NETWORK_ADD_CI), By.id(txt_NETWORK_ADD_CI), dropdownName);
    }
...
//        WebElement Element=findElement(By.xpath("//input[@type='text']"));
        WebElement Element=findElement(By.id("s2id_autogen11_search"));
        Element.sendKeys(dropdownName);
         wait(700);
       // Element.sendKeys(Keys.ARROW_DOWN);
        Element.sendKeys(Keys.ENTER);
//        Element.sendKeys(Keys.TAB);
    ...
    public void selectSMTP_RELAY(String dropdownName){
        ...
        selectDropdown(By.id(dd_SMTP_RELAY), By.id(txt_SMTP_RELAY), dropdownName);
    }
