@BR-2965_Tieto_Reject @Tieto
Feature: creation and sending of WO to Tieto - Tieto Rejects
  Scenario: user is able to create and send a WO to Tieto - Tieto Rejects
