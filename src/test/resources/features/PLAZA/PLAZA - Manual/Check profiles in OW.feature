@CheckprofilesinOW
  Feature: Check profiles in OW
    Scenario: Check profiles in OW
      ...
      Then user enters splunk description as "Test Description"
      And user enters splunk H2 Name Hid as "Test H2"
      ...
      Then user should see assigned profile as "IT-Application-OSS"
