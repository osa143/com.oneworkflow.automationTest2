@SAO-5782_Helix_Status

Feature: As a fault management system Helix should be able to see the status of OW tickets
  Scenario: As a fault management system Helix should be able to see the status of OW tickets
    ...
    And user stores ticket status
    And user goes back to Helix system
    And user validates OW ticket status is present in Helix
