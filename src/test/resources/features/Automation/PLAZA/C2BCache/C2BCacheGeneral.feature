@C2BCacheGeneral @PLAZA @C2B_Tests
Feature: Plaza C2B Cache form test
  Scenario Outline: user validates information sent to OW from Plaza
    ...
    And user enters C2B general request as "<Request>"
    And user selects select request as "Database dump (Prod)"
    And user selects C2B general environment as "<Environment>"
    And user enters C2B general description as "<Description>"
