...
formatter.step({
  "name": "user validates change builder+ is mandatory",
  "keyword": "And "
});
formatter.match({
  "location": "OWF_ChangeRecordPageSteps.userValidatesChangeBuilderIsMandatory()"
});
formatter.result({
  "status": "passed"
});
...
formatter.step({
  "name": "user validates reason text field expand button is present",
  "keyword": "And "
});
formatter.match({
  "location": "OWF_ChangeRecordPageSteps.userValidatesReasonTextFieldExpandButtonIsPresent()"
});
formatter.result({
  "status": "passed"
});
...
formatter.step({
  "name": "user enters start time as 24 hours fast from current sweden time in \"dd/MM/yyyy HH:mm:ss\" format",
  "keyword": "And "
});
formatter.match({
...
formatter.step({
  "name": "user enters end time as 28 hours fast from current sweden time in \"dd/MM/yyyy HH:mm:ss\" format",
  "keyword": "And "
});
formatter.match({
...
formatter.step({
  "name": "change should also be reflected in the timeline as \"STATUS MODIFIED.  Description has changed from - Additional Information to TEST TICKET PLEASE IGNORE - New Description. \"",
  "keyword": "Then "
});
formatter.match({
  "location": "OWF_ProblemRecordPageSteps.changeShouldAlsoBeReflectedInTheTimelineAs(String)"
...
formatter.step({
  "name": "user clicks on request that\u0027s \"Pending Approval\"",
  "keyword": "And "
});
formatter.match({
  "location": "OWF_ChangeRecordPageSteps.userClicksOnRequestThatS(String)"
});
formatter.result({
  "status": "skipped"
});
formatter.step({
  "name": "user selects CAB approval",
  "keyword": "Then "
});
formatter.match({
  "location": "OWF_ChangeRecordPageSteps.userSelectsApproval()"
});
formatter.result({
  "status": "skipped"
});
...
formatter.step({
  "name": "user should see \"Approved-ChangeBuilder\" email update",
  "keyword": "Then "
});
formatter.match({
  "location": "OWF_ChangeRecordPageSteps.userShouldSeeEmailUpdate(String)"
...
formatter.step({
  "name": "user logs in with valid username \"ChangeImplementationControl1\" and password as \"Test@1234\"",
  "keyword": "When "
});
formatter.match({
  "location": "OWF_LoginPageSteps.userLogsInWithValidUsernameAndPasswordAs(String,String)"
...
formatter.step({
  "name": "change should also be reflected in the timeline as \"Request Status has changed from Scheduled to Implementation. \" on row 2",
  "keyword": "Then "
});
formatter.match({
...
formatter.step({
  "name": "user clicks yes on impact update confirmation",
  "keyword": "And "
});
formatter.match({
  "location": "OWF_ChangeRecordPageSteps.userClicksYesOnImpactUpdateConfirmation()"
});
formatter.result({
  "status": "skipped"
});
...
formatter.step({
  "name": "change should also be reflected in the timeline as \"Completed Code has changed from  to Successful. Request Status has changed from Implementation to Completed. \"",
  "keyword": "And "
});
formatter.match({
  "location": "OWF_ProblemRecordPageSteps.changeShouldAlsoBeReflectedInTheTimelineAs(String)"
