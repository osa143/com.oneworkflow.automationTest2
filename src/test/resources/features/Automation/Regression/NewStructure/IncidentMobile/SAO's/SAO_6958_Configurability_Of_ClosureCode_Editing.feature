@Incident_SAO
   Feature: SAO-6958
    ...
    @6958_2
     #To DO: Update Date when running to match current date-29 days
...
#      And user selects agent console search trouble event
     ...
     And user enters "'Event Start Time' > \"2021/10/10\" AND 'Event End Time' != $NULL$" in the advanced search bar
     And user clicks Search on ticket search
