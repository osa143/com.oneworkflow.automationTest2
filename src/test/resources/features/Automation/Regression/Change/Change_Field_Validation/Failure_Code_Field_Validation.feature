...
Feature: validation of Closure Code field structure
  Scenario: validation of status field structure
    ...
    Then multiple statuses "Faulty Equipment or spare parts:Insufficient impact assessment:Insufficient planning:Insufficient testing:Other (specify in timeline):Planned time or impact duration exceeded:Unsuccessful rollback:Wrong configuration and/or faulty software:Cancelled:(clear)" should be available in "Failure Code*" dropdown
