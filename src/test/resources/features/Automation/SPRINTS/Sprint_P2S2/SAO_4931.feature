@4931
   Feature: SAO-4931
    Scenario: Time zone visibility harmonization
     ...
     And user should see specified Timezone as "GMT+0100 (British Summer Time)" top right under username
     When user selects "Console" menu as "SID Console"
     And user switches to window 1
     Then user should see specified Timezone as "GMT+0100 (British Summer Time)" top right under username
