...
Feature: To verify records are archived succesfully based on archive critera set - OS3:CM:RiskAnswers form
  Scenario: To verify records are archived succesfully based on archive critera set - OS3:CM:RiskAnswers form
    ...
    And user navigates to the "OS3:CM:RiskAnswers" form
    And user enters "%" in the "Question" field
    ...
    Then user opens new tab
    And user navigates to the "OS3:CM:RiskAnswers_Archive" form
    And user enters "%" in the "Question" field
    Then user clicks on form search button
    And user stores amount of records shown
    Then user clicks on form refresh button
