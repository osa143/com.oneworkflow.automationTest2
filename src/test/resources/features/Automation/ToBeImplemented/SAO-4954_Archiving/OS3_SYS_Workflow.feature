...
Feature: To verify records are archived succesfully based on archive critera set - OS3:SYS:Workflow_Archive form
  Scenario: To verify records are archived succesfully based on archive critera set - OS3:SYS:Workflow_Archive form
    ...
    And user navigates to the "OS3:SYS:Workflow" form
    And user enters "%" in the "User" field
    ...
    Then user opens new tab
    And user navigates to the "OS3:SYS:Workflow_Archive" form
    And user enters "%" in the "User" field
    Then user clicks on form search button
    And user stores amount of records shown
    Then user clicks on form refresh button
