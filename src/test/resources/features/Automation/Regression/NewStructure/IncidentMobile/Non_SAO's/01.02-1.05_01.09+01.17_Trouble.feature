@1.02-1.05Trouble @Incident_NonSAO
...
#      When user clicks on OP sweden checkbox under affected BU's
      ...
      Then multiple statuses "1:Access:BSS:Computer Equipment:Computer Services:CORE:CORE-VAS:Customer Services:DS:External:Hardware:Internal Service:IOT:IT:Location:Miscellaneous:Network:Nokia:OSS:Packet_Transport:Process:Product:SERVER:Service:Service Platform:SITE-LP:Software:Telecom:Transmission:Transport:TV:VAS" should be available in "Category" dropdown
