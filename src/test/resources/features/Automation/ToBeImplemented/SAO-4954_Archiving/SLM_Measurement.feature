...
Feature: To verify records are archived succesfully based on archive critera set - SLM:Measurement_Archive form
  Scenario: To verify records are archived succesfully based on archive critera set - SLM:Measurement_Archive form
    ...
    And user enters "%" in the "SVT Instance ID" field
    ...
    Then user opens new tab
    And user navigates to the "SLM:Measurement_Archive" form
    And user enters "%" in the "SVT Instance ID" field
    Then user clicks on form search button
    And user stores amount of records shown
    Then user clicks on form refresh button
