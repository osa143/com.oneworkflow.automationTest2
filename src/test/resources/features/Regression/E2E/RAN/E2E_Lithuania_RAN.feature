...
Feature: E2E Scenarios
  Scenario: E2E Scenarios for lithuania trouble event
    ...
    When user selects CI "LT_SGSN_LT-CSGN01MME"
    And user selects CI "LT_SGSN_LT-CSGN02MME"
    And user selects CI "SE_SGSN_AKH902MME"
    ...
    And user validates "Primary" CI is equal to "LT_SGSN_LT-CSGN01MME"
    Then user clicks on save button
