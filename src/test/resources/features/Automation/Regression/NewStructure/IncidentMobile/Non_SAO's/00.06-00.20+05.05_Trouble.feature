...
#        | PLAZA         |                          |
        ...
        | Access network:Mobile:RAN:Deployment SE | NW Deployment Eltel-SE:NW Deployment Netel-SE:NW Deployment OneCo-SE:NW Deployment RQA Team-SE:NW Deployment Scanmast-SE:NW Deployment Support-SE    |
...
#  checkmanual      | IT:Application | Application Identity & Access:Application-NO:Assurance:Billing-NO:CTI Admin-FI:Enterprise:IT App CDL:IT App Customer Identity:IT App eBS Platform:IT App Integration-SE:IT App NIAM-Common:IT App RODOD:IT App Telia Finance:JobSchedulling-FI:Middleware:Multibella-FI:NMS:Portal-NO:SAP:TAC1-NO:Tiksu-FI:Tunnestiimi-FI |
         | IT:Application:Analytics | IT App Analytics&BI-EE |
                | IT:Application:Billing | Billing:IT App Bill BiC:IT App Bill MOP2:IT App Bill MPS/RTS:IT App Bill Reflex:IT App Rodod BRM:IT App Billing-EE |
        | IT:Application:BSS | IT App BSS CeSim:IT App BSS CRT:IT App BSS Documentation:IT App BSS E-shop EE:IT App BSS Event:IT App BSS Freya:IT App BSS Marketstore:IT App BSS OCC:IT App BSS Produktguiden:IT App BSS Sales_Order Mgmt-EE:IT App BSS RR2R:IT App BSS WebS MultiDevice:IT App Integration BASE |
        | IT:Application:Contact Center | IT App CC CIS Operations SP:IT App CC CIS Support |
        | IT:Application:CRM | CRM:IT App CRM Alpha:IT App CRM API Market:IT App CRM Apollo:IT App CRM C2B Cache:IT App CRM C2B Services:IT App CRM C2B Caesar:IT App Cust Services-EE:IT App CRM DevOps Tools:IT App CRM Koda:IT App CRM OMT:IT App CRM OPT:IT App CRM Promis:IT App CRM Rodod UIM:IT App CRM Rodod AIA:IT App CRM Rodod OSM:IT App CRM Rodod Siebel:IT App CRM SINN:IT App CRM UOR |
        ...
        | IT:Application:Digital Channels | IT App CRM Vart Telia:IT App DigCh Broadband Sales:IT App DigCh Drools Flow:IT App DigCh Infra:IT App DigCh Mitt Telia:IT App DigCh Mitt Telia App:IT App DigCh Mobile Sales:IT App DigCh Mybusiness:IT App DigCh Order Flows:IT App DigCh Redaktionen:IT App DigCh Support:IT App DigCh Telia Admin:IT App DigCh telia.se |
        ...
        | IT:Application:Enterprise Services | IT App ES Dynamics AX-EE |
        | IT:Application:ESS | IT App ESS NetBase&BlueIce:IT App ESS NetBase&BlueIce L1:IT App ESS NetBase&BlueIce L2:IT App ESS PCM Partner Connect:IT App ESS Rambo |
        ...
        | IT:Application:Inventory | IT App Invent H2 SPOCs:IT App Invent Netw Dev Tool-EE:IT App Invent AINO:IT App Invent ArkivX:IT App Inventory Coppar GUI:IT App Inventory CSS:IT App Inventory EAI:IT App Inventory EIAS:IT App Inventory Qliksense:IT App Inventory Regnbage:IT App Inventory TelSIMS:IT App Inventory-EE |
        | IT:Application:Netadmin  | IT App OSS Netadmin |
        | IT:Application:OSS | IT-Application-OSS:IT App OSS Bemo:IT App OSS Cview-EAI:IT App OSS E-B2B:IT App OSS EEIS:IT App OSS FaDA:IT App OSS Flowview:IT App OSS Goldpen:IT App OSS Helix:IT App OSS Herkules:IT App OSS NAC-Julia:IT App OSS NetPro:IT App OSS Service Gateway:IT App OSS Slice:IT App OSS SOM -DK:IT App OSS SOM -EE:IT App OSS SOM -NO:IT App OSS WebOSS:IT App OSS Websystem Linjenat |
        ...
        | IT:OSS | IT OSS COM OPS:Keycom-FI:Satellite-FI |
        ...
        | OSS:Workflow | OSS WF JIRA/CONFLUENCE:OSS WF Trouble Ticket-EE:SIA -common:SIA-Tieto |
      ...
      When user enters "Test case 00.06-00.20" in Title field
      And user selects request type as "Customer" on trouble event page
      And user enters description as "Test case 00.06-00.20"
