@NNM_No @PLAZA
  #passed
  Feature: NNM No plaza form test
...
#      And user clicks on show more button
     ...
     # Then user selects system name in haiti as "Other"
      ...
      And user enters NNM request as "Test2 NNM/Request"
      And user selects Glana as "No"
      And user enters NNM DNS IP Address as "example.teliacompany.net/192.168.1.1"
      Then user enters NNM description as "Test2 NNM/Description"
      And user enters additional comments as "Test2 NNM/AC"
