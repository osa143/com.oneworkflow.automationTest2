@OS3_CM_ApprovalRequest

Feature: To verify records are archived succesfully based on archive critera set - OS3:CM:ApprovalRequest form
  Scenario: To verify records are archived succesfully based on archive critera set - OS3:CM:ApprovalRequest form
    ...
    And user navigates to the "OS3:CM:ApprovalRequest" form
    And user enters "%" in the "Approval Process" field
