@Network_Security_Proxy_Surf_Proxy @PLAZA @Network_Security
  #passed
  Feature: Network Security Proxy Surf Proxy plaza form test
    Scenario: user validates information sent to OW from Plaza
      ...
      And user enters URL as "Test.teliacompany.net"
      And user selects network security internal external website as "Yes"
      And user enters error message as "Test Error Message"
      And user enters has it worked before as "Test Work"
      And user enters when did the problem occure as "Test occure"
      And user enters what is your current proxy settings as "test proxy"
      And user enters ticket number as "Test ticket"
      And user enters network security proxy description as "Test4 Network Security Proxy/Description"
