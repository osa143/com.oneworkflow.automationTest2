Feature: MBOSS will be kept up to date with QoS site alarm incidents with active service disturbances and active CI impact records
  ...
  Scenario: QoS site alarm incidents with active service information and active CIs should be sent to MBOSS
  ...
  Scenario: QoS site alarm incidents with no active service information should not be sent to MBOSS
  ...
  Scenario: QoS site alarm incidents with no CIs with an active impact record should not be sent to MBOSS
    Given there is an incident with no CI with an active impact record
    When the MBOSS file automation generates a new file to send to MBOSS
    Then the incident and CIs will not be included in those files

  Scenario: QoS site alarm incidents with a mixture of CIs with active and inactive impact record should only send CIs with active impact records to MBOSS
    Given there is an incident with an active service information
  ...
  Scenario: QoS site alarm incidents with in closed, cleared and withdrawn should not be sent to MBOSS
