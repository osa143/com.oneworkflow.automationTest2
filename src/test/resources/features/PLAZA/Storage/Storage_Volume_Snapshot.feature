@Storage_Volume_Snapshot @PLAZA
  Feature: Storage Volume Snapshot plaza form test
    Scenario: user validates information sent to OW from Plaza
      ...
      And user enters Storage request as "Storage Volume Snapshot/Request"

      And user selects Choose Option as ""
      ...
      And user enters Storage description as "Test1 Storage Volume Snapshot/Description"
      And user enters additional comments as "Test1 Storage Volume Snapshot/AC"
