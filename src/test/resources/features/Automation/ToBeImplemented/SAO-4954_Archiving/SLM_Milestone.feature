...
Feature: To verify records are archived succesfully based on archive critera set - SLM:Milestone_Archive form
  Scenario: To verify records are archived succesfully based on archive critera set - SLM:Milestone_Archive form
    ...
    And user navigates to the "SLM:Milestone" form
    ...
    Then user opens new tab
    And user navigates to the "SLM:Milestone_Archive" form
    And user enters "%" in the "Title" field
    Then user clicks on form search button
    And user stores amount of records shown
    Then user clicks on form refresh button
