...
Feature: checking of bulk loading format
  Scenario: user checks the format of bulk loading format
      ...
      And user searches for "C:\Users\mahesh vaddegani\Downloads\Test Case Attachments 2\TemplatesForBulkCITests\10 CI's - Incorrect Names\BIR+Load+Template.csv" attachment and adds it
