@Bulk_Loading_Format_TXT_duplicateCIs_trouble @SAO-427
    #passed
Feature: checking of bulk loading format
    Scenario: user checks the format of bulk loading format
      ...
      #Blank default value for level
        ...
        And user searches for "C:\Temp\com.oneworkflow.automation\src\test\resources\Test_Attachments\TestCaseAttachments\5DuplicateCIs\5CIsTextDOC.txt" attachment and adds it
