...
Feature: checking of bulk loading format
  Scenario: user checks the format of bulk loading format
      ...
      And user searches for "C:\Users\mahesh vaddegani\Downloads\Test Case Attachments 2\TemplatesForBulkCITests\5 CIs - Duplicated CI's\BIR+Load+Template.xlsx" attachment and adds it
