...
#Only Transtema is present in SIT
  ...
  Feature: B2B Cancel work order to field service before work is carried out2
...
#        |B2B Automated Test - Lithuania Eltel |B2B Automation, Lithuania, Eltel  |LT_LTECell_2C67E012    |Eltel - FS - LT - B2B    |Huawei     |B2B Mobile Litauen                  |lars.bergh@eltelnetworks.se      |118 Hour 5 days Cleanup correction time workdays        |   1     |     1      |
