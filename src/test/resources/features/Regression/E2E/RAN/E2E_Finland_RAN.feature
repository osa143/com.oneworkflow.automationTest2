...
Feature: E2E Scenarios
  Scenario: E2E Scenarios for finland trouble event
    ...
    When user selects CI "FI_SGSN_FI-CSGN01MME"
    And user selects CI "FI_SGSN_FI-CSGN02MME"
    And user selects CI "LT_SGSN_LT-CSGN01MME"
    ...
    And user validates "Primary" CI is equal to "FI_SGSN_FI-CSGN01MME"
    Then user clicks on save button
      #Should be added automatically based on CI
    And user validates "Lithuania" BU is added automatically
