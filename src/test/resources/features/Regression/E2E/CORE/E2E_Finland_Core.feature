@E2E_Test_Finland_RAN @E2E_Test_Cases

Feature: E2E Scenarios
  Scenario: E2E Scenarios for finland trouble event
    ...
    Then user validates finland and denmark checkboxes are selected
    ...
    Then user should see list of finland sites
    #Location Name,Location ID+,Region Name, Region ID, Latitude, Longitude
    And user highlights location "FI_Site_riutula keskus" and clicks ok and validates location details
    When user enters "Test case MT004 Finland E2E" in Title field in Trouble event
    And user selects request type as "Customer" on trouble event page
    And user enters description as "Test case MT004 Finland E2E"
    ...
    And  user enters "FI_SGSN_HKIMME02" in name field
    Then user clicks on search button on CI search window
    And user selects CI "FI_SGSN_HKIMME02"
    ...
    And user enters "EE_EPG_KOORTEPG1" in name field
    Then user clicks on search button on CI search window
    And user selects CI "EE_EPG_KOORTEPG1"
    And user clicks on relate CI
    And user selects impact level as "Degradation of Service"
    Then user clicks on relate CI
    ...
    And user validates "Primary" CI is equal to "FI_SGSN_HKIMME02"
    Then user clicks on save button
      #Should be added automatically based on CI
    And user validates "Estonia" BU is added automatically
